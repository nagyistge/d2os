...
if [[ $1 == "dfs" ]]; then
	...
	rm ./bin/dfs.jar
	#javac -server -d ./classes/ -cp $CPFILES $JFILES -Xlint
	javac -server -d ./classes/ -cp './bin/d2os.jar:'$CPFILES $JFILES
	if [[ $? -eq 0 ]]; then
...
if [[ $1 == "watershed" ]]; then
	...
	#javac -server -d ./classes/ -cp $CPFILES $JFILES -Xlint
	javac -server -d ./classes/ -cp './bin/d2os.jar:./bin/dfs.jar:'$CPFILES $JFILES
	if [[ $? -eq 0 ]]; then
...
if [[ $1 == "mapred" ]]; then
	...
	rm ./bin/mapred.jar
	#javac -server -d ./classes/ -cp $CPFILES $JFILES -Xlint
	javac -server -d ./classes/ -cp './bin/d2os.jar:./bin/dfs.jar:./bin/dpm.jar:'$CPFILES $JFILES
	if [[ $? -eq 0 ]]; then
...
if [[ $1 == "samples" ]]; then
	...
	rm ./bin/samples.jar
	#javac -server -d ./classes/ -cp $CPFILES $JFILES -Xlint
	javac -server -d ./classes/ -cp './bin/d2os.jar:./bin/dfs.jar:./bin/watershed.jar:'$CPFILES $JFILES
	if [[ $? -eq 0 ]]; then
